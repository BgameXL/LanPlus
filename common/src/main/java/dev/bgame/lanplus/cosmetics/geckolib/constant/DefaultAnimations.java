...
package dev.bgame.lanplus.cosmetics.geckolib.constant;
...
import dev.bgame.lanplus.cosmetics.geckolib.animation.PlayState;
...
public final class DefaultAnimations {
	 ...
	 * Recommended:
	 * <ul>
	 *     <li>{@link dev.bgame.lanplus.cosmetics.geckolib.animatable.GeoEntity GeoEntity}: state -> animatable</li>
	 *     <li>{@link dev.bgame.lanplus.cosmetics.geckolib.animatable.GeoBlockEntity GeoBlockEntity}: state -> animatable</li>
	 *     <li>{@link dev.bgame.lanplus.cosmetics.geckolib.animatable.GeoReplacedEntity GeoReplacedEntity}: state -> state.getData(DataTickets.ENTITY)</li>
	 *     <li>{@link dev.bgame.lanplus.cosmetics.geckolib.animatable.GeoItem GeoItem}: state -> state.getData(DataTickets.ITEMSTACK)</li>
