...
public final class MolangQueries {
	...
	/**
	 * Update the currently rendering animatable. Should be called via {@link GeoModel#applyMolangQueries(AnimationState, double) GeoModel.applyMolangQueries} when rendering
	...
	/**
	 * Cleanup method called automatically by {@link dev.bgame.lanplus.cosmetics.vendored.geckolib.renderer.GeoRenderer#defaultRender} to eliminate a memory leak
	 */
