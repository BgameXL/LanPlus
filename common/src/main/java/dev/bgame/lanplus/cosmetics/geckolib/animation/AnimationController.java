...
package dev.bgame.lanplus.cosmetics.geckolib.animation;

import dev.bgame.lanplus.cosmetics.geckolib.animation.keyframe.*;
...
import dev.bgame.lanplus.cosmetics.geckolib.animation.keyframe.*;
import dev.bgame.lanplus.cosmetics.geckolib.animation.keyframe.event.CustomInstructionKeyframeEvent;
import dev.bgame.lanplus.cosmetics.geckolib.animation.keyframe.event.ParticleKeyframeEvent;
...
import dev.bgame.lanplus.cosmetics.geckolib.animation.keyframe.event.data.ParticleKeyframeData;
import dev.bgame.lanplus.cosmetics.geckolib.animation.keyframe.event.data.SoundKeyframeData;
import dev.bgame.lanplus.cosmetics.geckolib.animation.state.BoneSnapshot;
...
import dev.bgame.lanplus.cosmetics.geckolib.loading.math.MolangQueries;
